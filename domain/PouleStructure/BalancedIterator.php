 ...
 */
final class BalancedIterator implements Iterator
{
    private SportRange $pouleRange;
    private BalancedPouleStructure|null $current;
    private BalancedPouleStructureCreator $balancedCreator;
    ...
    public function __construct(
        ...
        $this->balancedCreator = new BalancedPouleStructureCreator();
        if ($pouleRange === null) {
