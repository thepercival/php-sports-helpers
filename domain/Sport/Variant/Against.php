...
abstract class Against extends Base implements Variant
{
     ...
     * @return int
     */
    public function getNrOfAgainstCombinationsPerGame(AgainstSide|null $side = null): int {
    ...
    public function getNrOfWithCombinationsPerGame(AgainstSide|null $side = null): int {
