...
class GamesPerPlace extends AgainstWithPoule
{
    ...
    public function getTotalNrOfSidePlaces(AgainstSide $side): int
    {
...
//    }
    ...
    public function allPlacesSameNrOfOfSidePlacesAssignable(AgainstSide $side): bool
    {
    ...
    public function allWithSameNrOfGamesAssignable(AgainstSide|null $side = null): bool
    {
